            ...
            foreach (var size in Size.All)
            {
                ...
                var expectedSizeCount = shirts
                    .Count(s => s.Size.Id == size.Id
                                && searchOptions.Sizes.Any(so => so.Id == s.Size.Id) // Should consider the given search options (as specified in the requirements)
            ...
            foreach (var color in Color.All)
            {
                ...
                var expectedColorCount = shirts
                    .Count(c => c.Color.Id == color.Id
                                && searchOptions.Colors.Any(so => so.Id == c.Color.Id)  // Should consider the given search options (as specified in the requirements)
